...
const ThreadChat = () => {
  ...
  const handleBack = () => {
    ...
    router.replace(isBusinessAccount ? '/(app)/business-hub' : '/(tabs)/seller-hub');
  };
  ...
  const handleViewListing = () => {
    ...
    router.push({ pathname: '/(app)/marketplace/[id]', params: { id: listingId } });
  };
    ...
    <View style={styles.screen}>
      ...
      >
        <View style={styles.chatShell}>
          ...
          >
            <View style={styles.chatHeroTopRow}>
              <TouchableOpacity style={styles.backPillButton} onPress={handleBack} activeOpacity={0.85}>
                <Text style={styles.backPillText}>← Back</Text>
              </TouchableOpacity>
              <View style={{ flex: 1, marginLeft: 12 }}>
                <Text style={styles.chatHeroTitle} numberOfLines={1}>{otherUserSummary.name}</Text>
                <Text style={styles.chatHeroSubtitle} numberOfLines={1}>{listingTitle || 'Conversation'}</Text>
              </View>
            </View>
            ...
            {listingImage ? (
              ...
              <View style={styles.listingInfo}>
                <Text style={styles.listingLabel}>Related listing</Text>
              ...
              >
                ...
                <View style={styles.reportMenuWrap}>
                  <TouchableOpacity style={styles.reportButton} onPress={() => setShowReportMenu((open) => !open)} activeOpacity={0.85}>
                    <Text style={styles.reportButtonText}>Safety</Text>
                  </TouchableOpacity>
