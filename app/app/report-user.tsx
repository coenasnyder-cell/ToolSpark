...
import ScreenTitleRow from '../../components/site-tools/ScreenTitleRow';
...
export default function ReportUserScreen() {
  ...
  return (
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      <KeyboardAwareFormScreen contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
